...
<style>
    ...
    .result-header.aprobado { background: linear-gradient(135deg, #0B5E2E 0%, #0d7a3f 100%); }
    ...
    .result-btn-primary { background: #0B5E2E; color: white; }
    .result-btn-primary:hover { background: #0d7a3f; color: white; }
    .result-btn-gold { background: #C9A227; color: white; }
    ...
    .result-btn-outline:hover { border-color: #0B5E2E; color: #0B5E2E; }
</style>
