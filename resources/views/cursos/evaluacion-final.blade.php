...
<style>
    ...
    .eval-header { background: linear-gradient(135deg, #0B5E2E 0%, #0d7a3f 100%); padding: 30px; color: white; text-align: center; }
    ...
    .eval-question-num { display: inline-block; background: #0B5E2E; color: white; padding: 2px 10px; border-radius: 6px; font-size: 12px; font-weight: 600; margin-right: 8px; }
    ...
    .eval-option:hover { border-color: #0B5E2E; background: #f0fdf4; }
    .eval-option input[type="radio"] { margin-right: 12px; accent-color: #0B5E2E; width: 18px; height: 18px; }
    ...
    .eval-btn { display: inline-flex; align-items: center; gap: 8px; padding: 14px 32px; background: #0B5E2E; color: white; border: none; border-radius: 10px; font-size: 16px; font-weight: 600; cursor: pointer; transition: all 0.2s; }
