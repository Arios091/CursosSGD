...
<style>
    ...
    .quiz-header { background: linear-gradient(135deg, #C9A227 0%, #d4af37 100%); padding: 30px; color: white; }
    ...
    .quiz-question-num { display: inline-block; background: #C9A227; color: white; padding: 2px 10px; border-radius: 6px; font-size: 12px; font-weight: 600; margin-right: 8px; }
    ...
    .quiz-option:hover { border-color: #C9A227; background: #fffbeb; }
    .quiz-option input[type="radio"] { margin-right: 12px; accent-color: #C9A227; width: 18px; height: 18px; }
    ...
    .quiz-btn { display: inline-flex; align-items: center; gap: 8px; padding: 14px 32px; background: #C9A227; color: white; border: none; border-radius: 10px; font-size: 16px; font-weight: 600; cursor: pointer; transition: all 0.2s; }
